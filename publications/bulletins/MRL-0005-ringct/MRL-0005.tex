...
\author[
   addressref={mrl},
   email={lab@getMKEcoin.org   shen.noether@gmx.com}
...
\ref{sec:Ring-CT-ForMKEcoin}, I require a generalization of the Back
...
\section{\label{sec:Ring-CT-ForMKEcoin}Ring CT For MKEcoin Protocol}
...
column is a Ring-CT ring in the sense of section \ref{sec:Ring-CT-ForMKEcoin}. 
