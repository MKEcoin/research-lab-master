...
#include <jni.h>
/* Header for class how_MKEcoin_hodl_jni_CryptoOpsUtil */

#ifndef _Included_how_MKEcoin_hodl_jni_CryptoOpsUtil
#define _Included_how_MKEcoin_hodl_jni_CryptoOpsUtil
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     how_MKEcoin_hodl_jni_CryptoOpsUtil
 * Method:    scalarMult
 * Signature: ([B[B)[B
 */
